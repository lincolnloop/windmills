...
env.hosts = ['perfo_analysis.dev.lincolnloop.com']
env.root = '/opt/webapps/perfo_analysis'
env.proj_root = env.root + '/src/perfo_analysis'
...
def clone():
    ...
    with cd('%s/perfo_analysis/conf/local' % env.proj_root):
